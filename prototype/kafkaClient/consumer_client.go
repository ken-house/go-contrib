...
type ConsumerClient interface {
	sarama.Consumer
	ConsumeTopic(topic string, isNew int64, consumeFunc func(message *sarama.ConsumerMessage)) error
}
...
func (cli *consumerClient) ConsumeTopic(topic string, isNew int64, consumeFunc func(message *sarama.ConsumerMessage)) error {
